...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        String sciFi = firstName.substring(0,3) + lastName.substring(0,2);
        String sciFiLast = city.substring(0,2) + school.substring(0,3);
        String b = relativeName1.substring((int) Math.random() * relativeName1.length());
        String d = relativeName2.substring((int) Math.random() * relativeName2.length());
        String origin = b + d;
        System.out.println("Welcome " + sciFi+ " " + sciFiLast + " of " + origin + ". Welcome!");
    }
}
